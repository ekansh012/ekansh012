...
<h3 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=22&color=FF0000&center=true&vCenter=true&width=500&lines=Full-stack+%26+AI+Enthusiast;Aspiring+DataScientist;Generative+AI%2FML+%26+RAG+Explorer;">
</h3>
<p align="center">
...
| --------------------------------- | ----------------------- | -------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------- |
| **GoogleGemini-ImageClassifier** | Machine Learning / AI | Python · Gemini API · Google GenerativeAI · Flask | An AI-powered image classification project that applies custom hashtags based on activity recognition in images. | [![Repo](https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github)](https://github.com/ekansh012/GoogleGemini-ImageClassifier) |
...
| **Letta Swarms Microagents**      | AI / Multi-Agent Systems                | Python · Letta.ai · Swarms · Ollama (Mistral 7B)    | A Python project demonstrating AI agents as microservices that collaborate via Swarms orchestration. Supports sequential, hierarchical, and majority-voting workflows to research, summarize, and generate intelligent responses. | [![Repo](https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github)](https://github.com/ekansh012/letta-swarms-microagents.git) |
