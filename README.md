...
| **Mini Alexa Voice Assistant** | A Python-based mini voice assistant that listens to commands, plays YouTube songs, tells time, fetches Wikipedia summaries, and tells jokes. | Python, SpeechRecognition, pyttsx3, pywhatkit, Wikipedia API, pyjokes | AI / Voice Assistant | [![Repo](https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github)](https://github.com/ekansh012/Mini_Alexa_VoiceAssistant) |
