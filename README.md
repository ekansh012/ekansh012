...
| **Mini Alexa Voice Assistant** | A Python-based mini voice assistant that listens to commands, plays YouTube songs, tells time, fetches Wikipedia summaries, and tells jokes. | Python, SpeechRecognition, pyttsx3, pywhatkit, Wikipedia API, pyjokes | AI / Voice Assistant | [🔗 View Repo](https://github.com/ekansh012/Mini_Alexa_VoiceAssistant) |
