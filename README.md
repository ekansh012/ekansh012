...
| --------------------------------- | ----------------------- | -------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------- |
| **GoogleGemini-ImageClassifier** | Machine Learning / AI | Python · Gemini API · Google GenerativeAI · Flask | An AI-powered image classification project that applies custom hashtags (e.g., #Earthivist, #ChiefAnimalOfficer, #WellnessChamp, #Promotivator) based on activity recognition in images. | [![Repo](https://img.shields.io/badge/View_Repo-181717?style=for-the-badge&logo=github)](https://github.com/ekansh012/GoogleGemini-ImageClassifier) |
